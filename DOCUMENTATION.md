 ...
 * **Parameters:** `target` — `String` — the filepath of the file/directory to delete
 ...
 * **Parameters:**
   ...
   * `[replace]` — `Boolean` — - whether or not to repalce existing files and directories (deafults to false)
 ...
 * **Parameters:** `target` — `String` — - the filepath of the directory to recursively list the files from
 ...
 * **Parameters:** `target` — `String` — - the filepath of the file to list the files from
 ...
 * **Parameters:** `target` — `String` — - the filepath to list the directories from
 ...
 * **Parameters:** `target` — `String` — - the filepath to list the file and directories from
 ...
 * **Parameters:** `target` — `String` — - the filepath of the file to test
 ...
 * **Parameters:** `target` — `String` — - the file to get the attributes from
 ...
 * **Parameters:** `target` — `String` — - the filepath of the file to check
 ...
 * **Parameters:** `target` — `String` — - the filepath of the file to get the time from
